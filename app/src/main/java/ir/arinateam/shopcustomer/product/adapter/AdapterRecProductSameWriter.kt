...
class AdapterRecProductSameWriter(
    private val context: Context,
    private val lsModelProduct: List<ModelRecHomeProduct>,
    private val productSelected: ProductSelected
) : RecyclerView.Adapter<AdapterRecProductSameWriter.ItemAdapter>() {
    ...
    override fun onBindViewHolder(holder: ItemAdapter, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            productSelected.onItemSelected(model.id)
